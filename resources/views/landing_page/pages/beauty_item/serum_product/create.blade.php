    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <h4 class="card-title">Create Serum Product</h4>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.serum.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" id="header_title" name="header_title" placeholder="Header Title Here.....">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="first_product_id" name="first_product_id">
                                        <option value="" disabled selected>Select First Product</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="second_product_id" name="second_product_id">
                                        <option value="" disabled selected>Select Second Product</option>
                                ...
                                <div class="table-responsive text-nowrap mb-3">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody class="table-border-bottom-0 useful_table_extend">
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control useful_list_name"  name="useful_list_name[]" required>
                                                </td>
                                                <td>
                                ...
                                <div class="table-responsive text-nowrap mb-3">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody class="table-border-bottom-0 why_table_extend">
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control why_list_name"  name="why_list_name[]" required>
                                                </td>
                                                <td>
