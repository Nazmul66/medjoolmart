    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Marquees List</h4>
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="card-title">Marquees List</h4>

                @if(auth("admin")->user()->can("create.marquee"))
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title" id="myModalLabel">Create Marquee</h5>
        ...
        <div id="editModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" data-bs-scroll="true"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title" id="myModalLabel">Update Marquee</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">X</button>
                    </div>
                    ...
                    <div class="modal-body">
                        <form id="EditForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="up_name" type="text" name="name" placeholder="Name">
        ...
        style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title" id="myModalLabel">View Marquee List</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#status', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.marquee.status') }}",
                    data: {
                        // '_token': token,
                        id: id,
                        status: status
