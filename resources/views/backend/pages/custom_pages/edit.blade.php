...
@section('body-content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Update Custom Pages</h4>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.customPage.update', $customPage->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="page_name" type="text" name="title" placeholder="Page Name" value="{{ old('title', $customPage->title) }}">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="status" id="statuss">
                                <option value="1" {{ old('status', $customPage->status ?? '') == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $customPage->status ?? '') == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="content" id="description" placeholder="Write here...." rows="8">{{ old('content', $customPage->content) }}</textarea>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <div id="image_preview" class="mt-3">
                                    @if ( !empty($customPage->meta_image) )
                                        <img src="{{ asset($customPage->meta_image) }}" width="100" height="100">
                                    @else
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="meta_title" id="meta_title" placeholder="Meta Title...."
                                    class="form-control" value="{{ old('meta_title', $customPage->meta_title) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <input name="meta_keyword" id="meta_keywords" type="text"
                                class="form-control meta_keyword" value="{{ old('meta_keywords', $customPage->meta_keyword) }}"
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="meta_description" id="meta_description" placeholder="Meta Description...."
                                rows="6">{{ old('meta_description', $customPage->meta_description) }}</textarea>
                        </div>
                    </div>
