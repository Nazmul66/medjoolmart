                                    ...
                                    <div class="row modal_slider">
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('public/frontend/images/zoom1.jpg') }}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('public/frontend/images/zoom2.jpg') }}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('public/frontend/images/zoom3.jpg') }}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="modal_slider_img">
                                                <img src="{{ asset('public/frontend/images/zoom4.jpg') }}" alt="product" class="img-fluid w-100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__pro_page_bammer">
                        <img src="{{ asset('public/frontend/images/pro_banner_1.jpg') }}" alt="banner" class="img-fluid w-100">
                                ...
                                <div class="row">
                                    <div class="col-xl-4  col-sm-6">
                                        <div class="wsus__product_item">
                                            ...
                                            <a class="wsus__pro_link" href="product_details.html">
                                                ...
                                                <img src="{{ asset('public/frontend/images/pro4_4.jpg') }}" alt="product"
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="wsus__product_item">
                                            <span class="wsus__new">New</span>
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/pro9.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/pro9_9.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        ...
                                        <div class="wsus__product_item">
                                            ...
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/pro2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/pro2_2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="wsus__product_item">
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/headphone_1.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/headphone_2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="wsus__product_item">
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/tab_1.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/tab_2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="wsus__product_item">
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/mobile_1.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/mobile_2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="wsus__product_item">
                                            ...
                                            <span class="wsus__minus">-20%</span>
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/pro8.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/pro8_8.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="wsus__product_item">
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/kids_1.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/kids_2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        ...
                                        <div class="wsus__product_item">
                                            ...
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/blazer_1.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/blazer_2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="wsus__product_item">
                                            <span class="wsus__new">New</span>
                                            <a class="wsus__pro_link" href="product_details.html">
                                                <img src="{{ asset('public/frontend/images/wemans_2.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_1" />
                                                <img src="{{ asset('public/frontend/images/wemans_1.jpg') }}" alt="product"
                                                    class="img-fluid w-100 img_2" />
                                            </a>
                                            <ul class="wsus__single_pro_icon">
                                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
