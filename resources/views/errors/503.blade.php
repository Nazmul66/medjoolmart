                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <div class="mb-5">
                                    <a href="index.html">
                                        <img src="{{ asset('public/backend/assets/images/logo-sm.svg') }}" alt="" height="30" class="me-1"><span class="logo-txt text-dark font-size-22">Minia</span>
                                    </a>
                                </div>
...
<!-- Mirrored from themesbrand.com/minia/layouts/pages-maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Feb 2022 18:01:10 GMT -->
</html>
