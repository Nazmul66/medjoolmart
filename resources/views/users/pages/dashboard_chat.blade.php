                  ...
                  <div class="wsus__chatlist_body">
                    <button class="nav-link" id="v-pills-home-tab" data-bs-toggle="pill"
                      ...
                      <div class="wsus_chat_list_img">
                        <img src="{{ asset('public/frontend/images/dashboard_user.jpg') }}" alt="user" class="img-fluid">
                        <span>5</span>
                      </div>
                    ...
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <div class="wsus_chat_list_img">
                        <img src="{{ asset('public/frontend/images/team_1.jpg') }}" alt="user" class="img-fluid">
                      </div>
                      <div class="wsus_chat_list_text">
                        <h4>imtiaz bulbul </h4>
                    ...
                    <button class="nav-link active" id="v-pills-messages-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <div class="wsus_chat_list_img">
                        <img src="{{ asset('public/frontend/images/ts-1.jpg') }}" alt="user" class="img-fluid">
                        <span>2</span>
                      </div>
                      <div class="wsus_chat_list_text">
                    ...
                    <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <div class="wsus_chat_list_img">
                        <img src="{{ asset('public/frontend/images/team_4.jpg') }}" alt="user" class="img-fluid">
                        <span>10</span>
                      </div>
                      <div class="wsus_chat_list_text">
                    ...
                    <button class="nav-link" id="v-pills-settings-tab1" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <div class="wsus_chat_list_img">
                        <img src="{{ asset('public/frontend/images/team_3.jpg') }}" alt="user" class="img-fluid">
                      </div>
                      <div class="wsus_chat_list_text">
                    ...
                    <button class="nav-link" id="v-pills-settings-tab2" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <div class="wsus_chat_list_img">
                        <img src="{{ asset('public/frontend/images/team_2.jpg') }}" alt="user" class="img-fluid">
                      </div>
                      <div class="wsus_chat_list_text">
                        <h4>kibrea munna</h4>
                        <span class="status">online</span>
                    ...
                    <button class="nav-link" id="v-pills-settings-tab3" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <div class="wsus_chat_list_img">
                        <img src="{{ asset('public/frontend/images/ts-3.jpg') }}" alt="user" class="img-fluid">
                      </div>
                      <div class="wsus_chat_list_text">
